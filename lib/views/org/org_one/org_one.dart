        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              Obx(() => Column(
                    children: controller.pageOne.requests
                        .map(_buildRecentRequestCard)
                        .toList(),
                  )),
              const SizedBox(height: 24),
              Row(
              ...
              const SizedBox(height: 12),
              Obx(() => Column(
                    children: controller.pageOne.tasks
                        .map(_buildCompletedTaskCard)
                        .toList(),
                  )),
            ],
          ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(
            ...
            Expanded(
                child: Text(req['location']?.toString() ?? '',
