...
class _RequestDetailsScreenState extends State<RequestDetailsScreen> {
  ...
  String get _statusLabel {
    switch (_status) {
      ...
      case 'approved':
        return 'Approved Â· Ready for Pickup';
      case 'pending':
  ...
  IconData get _serviceIcon {
    final t =
        (_detail?.serviceName ?? widget.request.serviceName).toLowerCase();
    ...
    if (t.contains('child') || t.contains('protect'))
      return Icons.shield_rounded;
    if (t.contains('educat')) return Icons.school_rounded;
    if (t.contains('psycho') || t.contains('mental'))
  ...
  Widget _body() {
    ...
    return CustomScrollView(
      slivers: [
        // â”€â”€ Hero AppBar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        SliverAppBar(
          expandedHeight: 240,
          pinned: true,
          backgroundColor: _darkGreen,
          ...
          flexibleSpace: FlexibleSpaceBar(
            background: Stack(fit: StackFit.expand, children: [
              // Background image â€” use network org logo or fallback color
              ...
              children: [
                ...
                Row(children: [
                  Expanded(
                    ...
                    iconColor: _green,
                    label: 'Aid Type',
                    value: d.serviceType.isNotEmpty
                        ? d.serviceType
                        : d.serviceName,
                  )),
  ...
  // â”€â”€ Status + Reference row â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Schedule & Logistics â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Widget _scheduleCard(RequestDetailModel d) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Column(children: [
              if (d.createdAt != null)
                _scheduleRow(Icons.event_available_rounded, _green,
                    'Arrival Date at Center', d.createdAt!),
              if (d.receivedAt != null) ...[
                if (d.createdAt != null) _divider(),
                _scheduleRow(Icons.schedule_rounded, const Color(0xFF8E44AD),
                    'Pickup Window', d.receivedAt!),
              ],
              if (d.sector != null && d.sector!.isNotEmpty) ...[
                _divider(),
                // Distribution Center row â€” matches Image 2
                Row(children: [
                  Container(
  ...
  // â”€â”€ Reference card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
