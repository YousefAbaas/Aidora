...
class _HomePage extends State<HomePage> {
  ...
  Future<void> _init() async {
    ...
    controller.failed.value =
        (d['statistics']?['failed'] as num?)?.toInt() ?? 0;
    controller.completed.value =
        (d['statistics']?['completed'] as num?)?.toInt() ?? 0;
    controller.pending.value =
        (d['statistics']?['pending'] as num?)?.toInt() ?? 0;
    controller.tasksthreeHome.assignAll(
      ((d['recent_tasks'] as List?) ?? [])
  ...
  Widget _buildHeader() {
    return Row(
      ...
      children: [
        Row(children: [
          // â”€â”€ Reactive volunteer avatar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Notification bell with badge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Obx(() {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Text('${task["created_display"]} â€¢ ${task["location"]}',
              style: const TextStyle(color: Colors.grey)),
        ])),
      ]),
    );
