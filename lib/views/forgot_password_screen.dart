...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _send() async {
    ...
    if (email.isEmpty || !email.contains('@')) {
      _snack('enter_email_hint'.tr, isError: true);
      return;
    }
  ...
  void _snack(String msg, {required bool isError}) {
    ...
    final display = msg.length > 120 ? '\${msg.substring(0, 120)}â€¦' : msg;
    Get.snackbar(
      isError ? 'Error' : 'âœ“',
      display,
      ...
      messageText: Text(
        display,
        style:
            TextStyle(fontSize: 13, color: isError ? Colors.red[800] : _green),
        maxLines: 3,
