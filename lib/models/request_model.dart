...
class RequestModel {
  ...
  // ── Approved ──────────────────────────────────────────────────
  final String? sector;           // delivery/distribution center name
  final String? approvedAt;       // "2 days ago" — approval time string
  final String? deliveryLocation; // explicit delivery location string
  final String? pickupTime;       // time window string e.g. "09:00 AM – 03:00 PM"

  // ── Complete ──────────────────────────────────────────────────
  final String? receivedAt;       // "Pickup 2d ago, 05 PM" — pickup time string

  // ── Rejected ──────────────────────────────────────────────────
  final String? rejectionReason;

  // ── Pending ───────────────────────────────────────────────────
  final String? createdAt;        // "Submitted 2d ago"
  ...
  factory RequestModel.fromJson(Map<String, dynamic> j) => RequestModel(
        ...
        deliveryLocation: j['delivery_location']?.toString() ?? j['sector']?.toString(),
        ...
        familyMembers:    j['family_members'] is int
                              ...
                              : int.tryParse(j['family_members']?.toString() ?? ''),
        imageUrl:         j['image_url']?.toString(),
      );

  Map<String, dynamic> toJson() => {
        'id': id, 'ref': ref, 'status': status, 'service_name': serviceName,
  ...
  RequestModel copyWith({
    String? id, String? ref, String? status, String? serviceName,
    String? sector, String? approvedAt, String? deliveryLocation,
    String? pickupTime, String? receivedAt, String? rejectionReason,
    String? createdAt, String? orgName, String? orgLogo,
    String? serviceType, int? familyMembers, String? imageUrl,
  }) => RequestModel(
        id:               id               ?? this.id,
        ref:              ref              ?? this.ref,
