...
class AppTheme {
  // â”€â”€ Light Theme (default) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/// Convenience extension â€” use context.cardColor, context.bgColor etc.
extension ThemeColors on BuildContext {
  bool get isDark => Theme.of(this).brightness == Brightness.dark;
  Color get bgColor =>
      isDark ? const Color(0xFF0F1923) : const Color(0xFFF5F3ED);
  Color get cardColor => isDark ? const Color(0xFF1A2535) : Colors.white;
  Color get cardColor2 =>
      isDark ? const Color(0xFF243040) : const Color(0xFFF8F8F8);
  Color get textColor =>
      isDark ? const Color(0xFFE8F0EE) : const Color(0xFF2C3E3C);
  Color get textSub => isDark ? const Color(0xFF8CA0A8) : Colors.grey.shade500;
  Color get borderColor =>
      isDark ? const Color(0xFF2A3A4A) : Colors.grey.shade200;
  Color get primaryGreen =>
      isDark ? const Color(0xFF4CAF88) : const Color(0xFF2C5F4F);
  Color get inputFill => isDark ? const Color(0xFF1A2535) : Colors.white;
  Color get iconBg =>
      isDark ? const Color(0xFF243040) : const Color(0xFFF0F4F2);
