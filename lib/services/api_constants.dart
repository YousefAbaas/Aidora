...
class ApiConstants {
  ...
  /// PATCH (requires auth) â€” complete/update refugee profile
  static const String completeProfile = '/api/auth/refugees/complete-profile/';

  /// GET  (requires auth) â€” refugee profile data
  static const String refugeeProfile = '/api/auth/profile/refugee/';

  /// POST (requires auth) â€” upload profile image
  ...
  /// GET /api/requests/<orgId>/services/   â†’ [{id, name, icon}]
  ...
  static String createRequest(int orgId) =>
      '/api/requests/$orgId/createrequest/';
  ...
  /// GET â€” volunteer QR code: /api/auth/volunteers/{id}/qr/
  static String volunteerQr(int volunteerId) =>
      '/api/auth/volunteers/$volunteerId/qr/';

  // â”€â”€ Volunteer endpoints (from new project) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Organization endpoints â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  /// GET  â†’ {service_name, service_description}
  /// POST â†’ body:{family_members, description, location}
