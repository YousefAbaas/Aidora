...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Future<UploadImageResult> uploadProfileImageXFile(
    ...
    try {
      ...
      debugPrint(
        'ðŸ“¸ Uploading to $url field=profile_image',
      );
      ...
      debugPrint(
        'ðŸ“¸ Response ${response.statusCode}: '
        '${response.body}',
      );
  ...
  Future<DeleteImageResult> deleteProfileImage() async {
    ...
    return DeleteImageResult.error(
      r.errorMessage ?? 'Failed to delete image',
    );
  }
}
